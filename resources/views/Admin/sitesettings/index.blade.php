        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('site_settings.update', $site_setting) }}"
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                                            id="title" name="title" placeholder="Site Title"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror"
                                            id="email" name="email" placeholder="Site Email"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                            ...
                                            value="{{ old('pri_phone', $site_setting->pri_phone) }}">
                                        @error('pri_phone')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="sec_phone">Secondary Phone Numbers</label>
                                        <input type="text"
                                            class="form-control @error('sec_phone') is-invalid @enderror"
                                            data-role="tagsinput" name="sec_phone"
                                            value="{{ old('sec_phone', $site_setting->sec_phone) }}">
                                        @error('sec_phone')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" class="form-control @error('pri_email') is-invalid @enderror"
                                            ...
                                            value="{{ old('pri_email', $site_setting->pri_email) }}">
                                        @error('pri_email')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="sec_email">Secondary Emails</label>
                                        <input type="text"
                                            class="form-control @error('sec_email') is-invalid @enderror"
                                            data-role="tagsinput" name="sec_email"
                                            value="{{ old('sec_email', $site_setting->sec_email) }}">
                                        @error('sec_email')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('pri_address') is-invalid @enderror" id="pri_address" name="pri_address"
                                            placeholder="Primary Address"><?php echo old('pri_address', $site_setting->pri_address); ?></textarea>
                                        @error('pri_address')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('sec_address') is-invalid @enderror" id="sec_address" name="sec_address"
                                            placeholder="Secondary Address"><?php echo old('sec_address', $site_setting->sec_address); ?></textarea>
                                        @error('sec_address')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group md-3">
                                            <input type="text" class="form-control @error('primary_logo') is-invalid @enderror"
                                                id="primary_logo" name="primary_logo" placeholder="Primary Logo" value="{{ old('primary_logo',$site_setting->primary_logo) }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group md-3">
                                            <input type="text" class="form-control @error('secondary_logo') is-invalid @enderror"
                                                id="secondary_logo" name="secondary_logo" placeholder="Select Logo For Mobile" value="{{ old('secondary_logo',$site_setting->secondary_logo) }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group md-3">
                                            <input type="text" class="form-control @error('loader') is-invalid @enderror"
                                                id="loader" name="loader" placeholder="Loader Image" value="{{ old('loader',$site_setting->loader) }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('url') is-invalid @enderror" id="url"
                                            ...
                                            value="{{ old('url', $site_setting->url) }}">
                                        @error('url')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('google_map_html') is-invalid @enderror" name="google_map_html" placeholder="Google Map HTML">{{old('google_map_html',$site_setting->google_map_html)}}</textarea>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('fb_link') is-invalid @enderror"
                                            ...
                                            value="{{ old('fb_link', $site_setting->fb_link) }}">
                                        @error('fb_link')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('twitter_link') is-invalid @enderror"
                                            ...
                                            value="{{ old('twitter_link', $site_setting->twitter_link) }}">
                                        @error('twitter_link')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('ig_link') is-invalid @enderror"
                                            ...
                                            value="{{ old('ig_link', $site_setting->ig_link) }}">
                                        @error('ig_link')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('linkedin_link', $site_setting->linkedin_link) }}">
                                        @error('linkedin_link')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('viber') is-invalid @enderror"
                                            ...
                                            value="{{ old('viber', $site_setting->viber) }}">
                                        @error('viber')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('pintrest_link', $site_setting->pintrest_link) }}">
                                        @error('pintrest_link')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('skype_link') is-invalid @enderror"
                                            ...
                                            value="{{ old('skype_link', $site_setting->skype_link) }}">
                                        @error('skype_link')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('facebook_page_id', $site_setting->facebook_page_id) }}">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('android') is-invalid @enderror"
                                            ...
                                            value="{{ old('android', $site_setting->android) }}">
                                        @error('android')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('ios') is-invalid @enderror" id="ios"
                                            name="ios" placeholder="Apple App Store"
                                            value="{{ old('ios', $site_setting->ios) }}">
                                        @error('ios')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('meta_key') is-invalid @enderror"
                                            ...
                                            value="{{ old('meta_key', $site_setting->meta_key) }}">
                                        @error('meta_key')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('meta_descriotion') is-invalid @enderror" id="meta_description"
                                            ...
                                            placeholder="Meta Description"><?php echo old('meta_description', $site_setting->meta_description); ?></textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('fb_title') is-invalid @enderror"
                                            ...
                                            value="{{ old('fb_title', $site_setting->fb_title) }}">
                                        @error('fb_title')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('fb_title') is-invalid @enderror"
                                            ...
                                            value="{{ old('twitter_title', $site_setting->twitter_title) }}">
                                        @error('twitter_title')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('fb_description') is-invalid @enderror" id="fb_description" name="fb_description"
                                            placeholder="Facebook Description"><?php echo old('fb_description', $site_setting->fb_description); ?></textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('fb_title') is-invalid @enderror" id="twitter_description"
                                            ...
                                            placeholder="Twitter Description"><?php echo old('twitter_description', $site_setting->twitter_description); ?></textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group md-3">
                                            <input type="text" class="form-control @error('fb_image') is-invalid @enderror"
                                                id="fb_image" name="fb_image" placeholder="Select Facebook Image" value="{{ old('fb_image',$site_setting->fb_image) }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group md-3">
                                            <input type="text" class="form-control @error('twitter_image') is-invalid @enderror"
                                                id="twitter_image" name="twitter_image" placeholder="Select Twitter Image" value="{{ old('twitter_image',$site_setting->fb_image) }}">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="online"
                                                {{ old('status', $site_setting->status) == 'online' ? 'selected' : '' }}>
                                                Online</option>
                                            <option value="offline"
                                                {{ old('status', $site_setting->status) == 'offline' ? 'selected' : '' }}>
                                                Offline</option>
                                        </select>
                                        @error('status')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('offline_msg') is-invalid @enderror"
                                            ...
                                            value="{{ old('offline_msg', $site_setting->offline_msg) }}">
                                        @error('offline_msg')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
