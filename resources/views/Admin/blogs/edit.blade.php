        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                                type="button" role="tab" aria-controls="home" aria-selected="true">Feature
                                Details</button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <form class="forms-sample" action="{{ route('blogs.update', $blog) }}" method="POST">
                        <div class="tab-content col-md-12" id="myTabContent">
                                ...
                                <div class="row">
                                        ...
                                        <select class="form-control @error('category') is-invalid @enderror" name="category"
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    {{ old('category', $blog->category) == $category->id ? 'selected' : '' }}>
                                                    {{ $category->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" id="old_subcategory"
                                            value="{{ old('sub_category', $blog->sub_category) }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text-area" class="form-control @error('tags') is-invalid @enderror"
                                            data-role="tagsinput" name="tags" value="{{ old('tags', $blog->tags) }}">
                                        @error('tags')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('tag_line') is-invalid @enderror"
                                            ...
                                            value="{{ old('tag_line', $blog->tag_line) }}">
                                        @error('tag_line')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control @error('is_featured') is-invalid @enderror" id="is_featured"
                                            name="is_featured">
                                            <option value="Yes" {{ old('is_featured',$blog->is_featured) == 'Yes' ? 'selected' : '' }}>
                                                Yes
                                            </option>
                                            <option value="No" {{ old('is_featured',$blog->is_featured) != 'Yes' ? 'selected' : '' }}>
                                                No
                                            </option>
                                        </select>
                                        @error('status')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('short_description') is-invalid @enderror" id="featured_image"
                                            ...
                                            placeholder="Short Description"><?php echo old('short_description', $blog->short_description); ?></textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('descptrion') is-invalid @enderror" id="summary-ckeditor" name="description"
                                            placeholder="Descprition"><?php echo old('description', $blog->description); ?></textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="setting">
                                            <option value="yes"
                                                {{ old('setting', $blog->setting) == 'yes' ? 'selected' : '' }}>
                                                Yes</option>
                                            <option value="no"
                                                {{ old('setting', $blog->setting) == 'no' ? 'selected' : '' }}>
                                                No</option>
                                        </select>
                                        @error('setting')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                            ...
                            <div class="tab-pane fade container" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                {{-- SEO Details --}}
                                @include('inputs.seo', ['seo_detail' => $blog])
