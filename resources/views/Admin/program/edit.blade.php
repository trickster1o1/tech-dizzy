        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('program.update',$event->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="tab-content col-md-12" id="myTabContent">
                            <div class="tab-pane fade show active container" id="home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    @include('inputs.mediainput',$data=['thumb_image','Thumb Image (370x306 px)','Upload Thumb Image',$event->thumb_image])
                                    @include('inputs.mediainput',$data=['featured_image','Featured/Banner Image (770x430 px)','Upload Featured Image',$event->featured_image])

                                    @include('inputs.mediainput',$data=['banner_image','Banner Image (1894x328 px)','Upload Banner Image',$event->banner_image])
                                    ...
                                    @include('inputs.text',$data=['organizer','Organizer','Enter Organizer','text',$event->organizer])
                                    @include('inputs.text',$data=['location','Location','Enter Location','text',$event->location])
                                    @include('inputs.text',$data=['target_amount','Target Amount','Enter Target Amount','text',$event->target_amount])
                                    @include('inputs.text',$data=['donation_amount','Donated Amount','Enter Donated Amount','text',$event->donation_amount])
