...
@section('content')
    <div class="page-header">
        ...
        @if (authorize($menucode, 'CREATE', false))
            <a href="{{ route('program.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
        @endif
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('program/data_ajax') }}">
                <thead class="thead bg-primary text-white font-weight-bold">
                    <tr>
                        ...
                        <th scope="col" data-column="target_amount" data-filter="1"> Target Amount</th>
                        <th scope="col" data-column="donation_amount" data-filter="1">Donation Amount</th>
                        <th scope="col" width="1%" data-column="order_by" data-filter="1">Sequence</th>
                        <th scope="col" data-column="is_featured" data-filter="1">Is Featured</th>
