        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('reviews.update', $review) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control @error('review_category') is-invalid @enderror"
                                            ...
                                            <option value="tours"
                                                {{ old('review_category', $review->review_category) == 'tours' ? 'selected' : '' }}>
                                                Tour
                                            </option>
                                            <option value="properties"
                                                {{ old('review_category', $review->review_category) == 'properties' ? 'selected' : '' }}>
                                                Property
                                            </option>
                                            <option value="destinations"
                                                {{ old('review_category', $review->review_category) == 'destination' ? 'selected' : '' }}>
                                                Destination
                                            </option>
                                            <option value="rooms"
                                                {{ old('review_category', $review->review_category) == 'rooms' ? 'selected' : '' }}>
                                                Room
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" id="status"
                                            name="status">
                                            <option value="active"
                                                {{ old('status', $review->status) == 'active' ? 'selected' : '' }}>
                                                Active
                                            </option>
                                            <option value="inactive"
                                                {{ old('status', $review->status) == 'inactive' ? 'selected' : '' }}>
                                                Inactive
                                            </option>
                                        </select>
                                        @error('status')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control @error('review_rating') is-invalid @enderror"
                                            ...
                                            <option value="1"
                                                {{ old('review_rating', $review->review_rating) == '1' ? 'selected' : '' }}>
                                                1
                                            </option>
                                            <option value="2"
                                                {{ old('review_rating', $review->review_rating) == '2' ? 'selected' : '' }}>
                                                2
                                            </option>
                                            <option value="3"
                                                {{ old('review_rating', $review->review_rating) == '3' ? 'selected' : '' }}>
                                                3
                                            </option>
                                            <option value="4"
                                                {{ old('review_rating', $review->review_rating) == '4' ? 'selected' : '' }}>
                                                4
                                            </option>
                                            <option value="5"
                                                {{ old('review_rating', $review->review_rating) == '5' ? 'selected' : '' }}>
                                                5
                                            </option>
                                        </select>
                                        @error('review_rating')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('review') is-invalid @enderror" id="review" name="review"
                                            placeholder="Review">{{ old('review', $review->review) }}</textarea>
                                        @error('review')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
