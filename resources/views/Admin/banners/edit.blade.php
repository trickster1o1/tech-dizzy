        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('banners.update', $banner) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('tag_line') is-invalid @enderror"
                                            ...
                                            value="{{ old('tag_line', $banner->tag_line) }}">
                                        @error('tag_line')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6 d-none">
                                        ...
                                        <select class="form-control" name="banner_type" id="">
                                            <option value="Image"
                                                {{ old('banner_type', $banner->banner_type) == 'Image' ? 'selected' : '' }}>
                                                Image
                                            </option>
                                            <option value="Video"
                                                {{ old('banner_type', $banner->banner_type) == 'Video' ? 'selected' : '' }}>
                                                Video</option>
                                        </select>
                                        @error('banner_type')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group md-3">
                                            <input type="text" class="form-control @error('image') is-invalid @enderror"
                                                id="image" name="image" placeholder="Image" value="{{ old('image', $banner->image) }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('primary_button_title', $banner->primary_button_title) }}">
                                    ...
                                    <div class="form-group col-md-6 d-none">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('secondary_button_title', $banner->secondary_button_title) }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            value="{{ old('primary_button_link', $banner->primary_button_link) }}">
