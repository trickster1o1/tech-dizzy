...
@section('content')
    <div class="page-header">
        <h3 class="page-title">Supporters </h3>

        @if (authorize($menucode, 'CREATE', false))
            <a href="{{ route('supporter.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
        @endif
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('supporter/data_ajax') }}">
                <thead class="thead bg-primary text-white font-weight-bold">
                    <tr>
                        ...
                        <th scope="col" data-column="amount" data-filter="1">Created By</th>
