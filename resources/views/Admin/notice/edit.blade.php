        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('notices.update', $notice) }}" method="POST">
                        <div class="tab-content col-md-12" id="myTabContent">
                            <div class="tab-pane fade show active container" id="home" role="tabpanel"
                                ...
                                <div class="row">
                                        ...
                                        <select class="form-control @error('category') is-invalid @enderror" name="category"
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    {{ old('category', $notice->category) == $category->id ? 'selected' : '' }}>
                                                    {{ $category->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" id="old_subcategory"
                                            value="{{ old('sub_category', $notice->sub_category) }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text"
                                            ...
                                            id="published_date" name="published_date" placeholder="published_date"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="datepicker form-control @error('expiary_date') is-invalid @enderror"
                                            id="expiary_date" name="expiary_date" placeholder="Expiary Date"
                                            value="{{ old('expiary_date', $notice->expiary_date) }}">
                                        @error('expiary_date')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="timepicker form-control @error('publish_time') is-invalid @enderror"
                                            ...
                                            value="{{ old('publish_time', $notice->publish_time) }}">
                                        @error('publish_time')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="timepicker form-control @error('expiary_time') is-invalid @enderror"
                                            ...
                                            value="{{ old('expiary_time', $notice->expiary_time) }}">
                                        @error('expiary_time')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text"
                                                ...
                                                value="{{ old('attached_file_url', $notice->attached_file_url) }}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_descptrion"
                                            ...
                                            placeholder="Short Description"><?php echo old('short_description', $notice->short_description); ?></textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('descptrion') is-invalid @enderror" id="summary-ckeditor" name="description"
                                            placeholder="Descprition"><?php echo old('description', $notice->description); ?></textarea>
                                        @error('description')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6 d-none">
                                        ...
                                        <select class="form-control @error('is_featured') is-invalid @enderror"
                                            ...
                                            <option value="yes"
                                                {{ old('is_featured', $notice->is_featured) == 'yes' ? 'selected' : '' }}>
                                                Yes
                                            </option>
                                            <option value="no"
                                                {{ old('is_featured', $notice->is_featured) == 'no' ? 'selected' : '' }}>
                                                No
                                            </option>
                                        </select>
                                        @error('is_featured')
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control @error('status') is-invalid @enderror" id="status"
                                            name="status">
                                            <option value="active"
                                                {{ old('status', $notice->status) == 'active' ? 'selected' : '' }}>
                                                Active
                                            </option>
                                            <option value="inactive"
                                                {{ old('status', $notice->status) == 'inactive' ? 'selected' : '' }}>
                                                Inactive
                                            </option>
                                        </select>
                                        @error('status')
                                    ...
                                    <div class="form-group col-md-6 d-none">
                                        ...
                                        <select class="form-control @error('publish_as_popup') is-invalid @enderror"
                                            ...
                                            <option value="yes"
                                                {{ old('is_featured', $notice->publish_as_popup) == 'yes' ? 'selected' : '' }}>
                                                Yes
                                            </option>
                                            <option value="no"
                                                {{ old('is_featured', $notice->publish_as_popup) == 'no' ? 'selected' : '' }}>
                                                No
                                            </option>
                                        </select>
                            ...
                            <div class="tab-pane fade container" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                {{-- SEO Details --}}
                                @include('inputs.seo', ['seo_detail' => $notice])
                            </div>
                            <div class="col-md-12">
                                @csrf
                                @method('PUT')
