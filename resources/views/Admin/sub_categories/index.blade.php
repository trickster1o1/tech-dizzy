...
@section('content')
    <div class="page-header">
        <h3 class="page-title"> Sub Catogories </h3>

        @if (authorize($menucode, 'CREATE', false))
            <a href="{{ route('sub_categories.create') }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Add New
            </a>
        @endif
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('sub_cat_data') }}">
                <thead class="  thead bg-primary text-white font-weight-bold">
                    <tr>
                        ...
                        <th scope="col" data-column="category_type_title" data-filter="1">Category Type</th>
