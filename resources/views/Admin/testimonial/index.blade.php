...
@section('content')
    <div class="page-header">
        ...
        @if (authorize($menucode, 'CREATE', false))
            <a href="{{ route('testimonial.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
        @endif
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('testimonial/data_ajax') }}">
                <thead class="thead bg-primary text-white font-weight-bold">
                    <tr>
                        ...
                        <th scope="col" data-column="name" data-filter="1">Full Name</th>
                        <th scope="col" data-column="message" data-filter="1">Message</th>
