        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('team-members.store') }}" method="POST">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('position') is-invalid @enderror"
                                            ...
                                            value="{{ old('position') }}">
                                        @error('position')
                                            <span class="invalid-feedback"> {{ $position }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control  @error('status') is-invalid @enderror"
                                            ...
                                            <option value="yes" {{ old('is_featured') == 'no' ? 'selected' : '' }}>Yes
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        @error('member_image')
                                            <span class="invalid-feedback"> {{ $member_image }} </span>
                                        @enderror
                                    </div>
