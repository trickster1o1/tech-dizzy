        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('faqs.update', $faq) }}" method="POST">
                        @csrf
                                ...
                                <div class="row">
                                        ...
                                        <select class="form-control" name="category" id="category">
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    {{ old('category', $faq->category) == $category->id ? 'selected' : '' }}>
                                                    {{ $category->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" id="old_subcategory"
                                            value="{{ old('sub_category', $faq->sub_category) }}">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control @error('question') is-invalid @enderror" id="question" name="question"
                                            placeholder="question"><?php echo old('question', $faq->question); ?></textarea>
                                        @error('question')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control @error('answer') is-invalid @enderror" id="answer" name="answer"
                                            placeholder="Answer"><?php echo old('answer', $faq->answer); ?></textarea>
                                        @error('answer')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
