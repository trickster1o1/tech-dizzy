                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('tagline') is-invalid @enderror"
                                            id="tagline" name="tagline" placeholder="Title" value="{{ old('tagline') }}">
                                        @error('tagline')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('link') is-invalid @enderror"
                                            id="link" name="link" placeholder="Title" value="{{ old('link') }}">
                                        @error('link')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    ...
                                    {{-- <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('icon_class') is-invalid @enderror"
                                            id="icon_class" name="icon_class" placeholder="Icon Class" value="{{ old('icon_class') }}">
                                        @error('icon_class')
                                            <span class=" invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('short_description') is-invalid @enderror" id="short_descptrion"
                                            name="short_description" placeholder="Short Description"><?php echo old('short_description'); ?></textarea>
                                    ...
                                    {{-- <div class="form-group col-md-6 d-none">
                                        <label for="related_services">Related Projects</label>
                                        <select class="form-control select2 @error('related_services') is-invalid @enderror"
                                            ...
                                            @foreach ($services as $service)
                                                <option value="{{ $service->id }}"
                                                    @if (old('related_services') != null && in_array($service->id, old('related_services'))) selected @endif>
                                                    {{ $service->title }}
                                                </option>
                                            @endforeach
                                        </select>
