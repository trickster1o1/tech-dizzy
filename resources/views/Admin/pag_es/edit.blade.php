        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('pages.update', $page) }}" method="POST">
                        <div class="tab-content col-md-12" id="myTabContent">
                            <div class="tab-pane fade show active container" id="home" role="tabpanel"
                                ...
                                <div class="row">
                                        ...
                                        <select class="form-control" name="category" id="category">
                                            ...
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    {{ old('category', $page->category) == $category->id ? 'selected' : '' }}>
                                                    {{ $category->title }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" id="old_subcategory" value="{{old('sub_category',$page->sub_category)}}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('tag_line') is-invalid @enderror"
                                            ...
                                            value="{{ old('tag_line', $page->tag_line) }}">
                                        @error('tag_line')
                                            <span class="invalid-feedback"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control @error('video_url') is-invalid @enderror"
                                            id="video_url" name="video_url" placeholder="Enter Video Link"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control @error('short_description') is-invalid @enderror" id="featured_image"
                                            ...
                                            placeholder="Short Description"><?php echo old('short_description', $page->short_description); ?></textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="form-control form-control @error('description') is-invalid @enderror" id="summary-ckeditor"
                                            name="description" placeholder="Descprition"><?php echo old('description', $page->description); ?></textarea>
                            ...
                            <div class="tab-pane fade container" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                 ...
                                 @include('inputs.seo',array('seo_detail'=>$page))
