        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('newsletter.store') }}" method="POST">
                        @csrf
                        <div class="tab-content col-md-12" id="myTabContent">
                            <div class="tab-pane fade show active container" id="home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="d-none">@include('inputs.date',$data=['date','Date*'])</div>
                                    @include('inputs.mediainput',$data=['thumb_image','Thumb Image (370x420 px)*','Enter Thumb Image',''])
                                    @include('inputs.mediainput',$data=['attachment','Attachment *','Enter Your Attachment',''])
