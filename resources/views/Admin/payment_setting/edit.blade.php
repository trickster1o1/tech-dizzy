        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('paymentsetting.update',$payment->id) }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="tab-content col-md-12" id="myTabContent">
                                <div class="tab-pane fade show active container" id="home" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        @include('inputs.text',[$data=['merchant_id','Merchant Id','Enter Merchant Id','text',$payment->merchant_id]])
                                        <div class="form-group col-md-6 d-none">
                                            <label for="tag_line">Esewa ID</label>
                                            <input type="text-area" class="form-control @error('esewa_id') is-invalid @enderror"
                                                data-role="tagsinput" name="esewa_id" value="{{ old('esewa_id',$payment->esewa_id) }}">
                                            @error('esewa_id')
                                    ...
                                    <div class="row">
                                        ...
                                        @include('inputs.textarea', [
                                                ($data = [
                                                    ...
                                                    'Paypal Form',$payment->paypal_form,
                                                    'md-6',
                                                    '4',
                                                ]),
                                            ]) 
                                        
                                        <div class="d-none"> @include('inputs.mediainput',[$data=['paypal_qr','Paypal QRcode','Upload Paypal QRcode',$payment->paypal_qr]])</div>
...
<script>
    window.onload = function() {
        //load_ckeditor('paypal_form', false);
    }
</script>
