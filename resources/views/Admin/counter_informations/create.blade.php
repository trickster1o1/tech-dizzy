...
@section('content')
    <div class="page-header">
        <h3 class="page-title"> Add Counter Information </h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('counter_infos.index') }}">Counter Informations</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Add Counter Information</li>
            </ol>
        </nav>
    </div>
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('counter_infos.store') }}" method="POST">
                        @csrf
