...
@section('content')
    <div class="page-header">
        <h3 class="page-title">Counter Informations </h3>

        @if (authorize($menucode, 'CREATE', false))
            <a href="{{ route('counter_infos.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
        @endif
    </div>
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('counter_data') }}">
                <thead class="thead bg-primary text-white font-weight-bold">
                    <tr>
                        ...
                        <th scope="col" width="30%" data-column="counter_number" data-filter="1">Counter No</th>
