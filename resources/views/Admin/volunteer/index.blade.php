...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('volunteer/data_ajax') }}">
                <thead class="thead bg-primary text-white font-weight-bold">
                    <tr>
                        ...
                        <th scope="col" data-column="address" data-filter="1">Address</th>
                        <th scope="col" width="1%" data-column="occupation" data-filter="1">Ocupation</th>
                        <th scope="col" width="1%" data-column="order_by" data-filter="1">Sequence</th>
                        <th scope="col" width="1%" data-column="accepted" data-filter="1">Accepted</th>
