...
@section('content')
    <div class="page-header">
        <h3 class="page-title"> Add Payment Method </h3>
        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('paymentmethod.store') }}" method="POST">
                        @csrf
                        <div class="tab-content col-md-12" id="myTabContent">
                            <div class="tab-pane fade show active container" id="home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    @include('inputs.text',$data=['method','Payment Method*','Enter Payment Method','text'])
                                    @include('inputs.text',$data=['code','Code*','Enter Code','text'])
                                    @include('inputs.mediainput',$data=['logo','Logo','Upload Payment Logo',''])
