        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('email_templates.store') }}" method="POST">
                        @csrf
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="text-area"
                                                ...
                                                data-role="tagsinput" name="custom_email" value="{{ old('custom_email') }}">
                                            @error('custom_email')
                                                <span class="invalid-feedback"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <textarea class="form-control @error('admin_message') is-invalid @enderror" id="admin_message" name="admin_message"
                                                placeholder="Admin Message">{{ old('admin_message') }}</textarea>
                                            @error('admin_message')
                                                <span class=" invalid-feedback"> {{ $message }} </span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('user_message') is-invalid @enderror" id="user_message" name="user_message"
                                                placeholder="User Message">{{ old('user_message') }}</textarea>
                                            @error('user_message')
                                                <span class=" invalid-feedback"> {{ $message }} </span>
                                            @enderror
                                        </div>
