...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card table-responsive">
            <table class="table bg-white list-data" id="list-data" data-url="{{ url('user_data') }}">
                <thead class="thead bg-primary text-white font-weight-bold">
                    <tr>
                        ...
                        <th scope="col" width="30%" data-column="name" data-filter="1">Name</th>
                        <th scope="col" data-column="phone" data-filter="1">Phone Number</th>
                        <th scope="col" data-column="email" data-filter="1">Email</th>
                        <th scope="col" width="1%" data-column="username" data-filter="1">User Name</th>
                        <th scope="col" width="1%" data-column="user_roles" data-filter="1">Role</th>
