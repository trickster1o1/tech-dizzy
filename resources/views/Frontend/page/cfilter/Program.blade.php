...
<section class="donations-page">
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="causes-one__single">
                            <div class="causes-one__img">
                                <img src="/{{$program->thumb_image ? $program->thumb_image : 'uploads/defaults/thumb/program.png'}}" alt="xaina">
            ...
            @else 
                <h2 align='center'>No Program Is Available In This Thematic Area</h2>
            @endif
        </div>
    </div>
</section>
